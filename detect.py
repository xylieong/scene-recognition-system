...
from utils import load_images, load_class_names, draw_boxes, draw_frame, save_detections

from PIL import ImageFile
ImageFile.LOAD_TRUNCATED_IMAGES = True # to avoid truncated images
...
#     main(sys.argv[1], float(sys.argv[2]), float(sys.argv[3]), int(sys.argv[4]), sys.argv[5:])
