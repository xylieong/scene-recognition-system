...
def non_max_suppression(inputs, n_classes, max_output_size, iou_threshold,
    ...
    boxes_dicts = []
    count = len(batch)
    print('-------Start creating boxes_dicts-----')
    for boxes in batch:
        count -= 1
        print(count)
    ...
    def __call__(self, inputs, training):
        ...
        with tf.compat.v1.variable_scope('yolo_v3_model'):
            ...
            detect3 = yolo_layer(inputs, n_classes=self.n_classes,
                                 ...
                                 img_size=self.model_size,
                                 data_format=self.data_format)
            print('detect3 Successful')


            inputs = tf.concat([detect1, detect2, detect3], axis=1)
            print('concat detect1 2 3 Successful')

            inputs = build_boxes(inputs)
            print('build boxes Successful')
            ...
            print('boxes_dicts created Successful')
            
#             for img_name, boxes_dict in zip(inputs, boxes_dicts):
